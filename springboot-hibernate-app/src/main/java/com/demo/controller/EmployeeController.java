...
import com.demo.srevice.EmployeeService;
...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> getDataById(@PathVariable int empId) {
        return ResponseEntity.ok(employeeServiceImpl.getDataBy(empId));
    }
    ...
    public ResponseEntity<String> deteleDataById(@PathVariable int empId) {
